...
function myMochaFunctionOWO()
	...
	Move(-155, -120, brushSizeText)
	Resize(50, 20, brushSizeText)
	...
	Move(-105, -100, brush_button)
	Resize(100, 20, brush_button)
	...
	Move(-105, -120, brush_button_plus)
	...
	Move(-130, -120, brush_button_minus)
